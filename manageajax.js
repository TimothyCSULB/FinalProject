        ...
        if (result.result.length === 0) {
            ...
            result.result.forEach(customer => { 
                ...
                <tr>
                    ...
                    <td><input type="button" onclick="location.href="/edit;" value="Edit" />
                    <td><input type="button" onclick="location.href="/delete;" value="Delete" />
                </tr>
             `
            });
           ...
           <table>
            <thead>
                <tr>
                    ...
                    <input type="button" onclick="location.href="/create;" value="Create Customer" />
                </tr>
            </thead>
            <tbody>
                ${tdText}
